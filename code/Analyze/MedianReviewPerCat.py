...
collection = db['MedianReviewPerCat']

data = []
for category, sellercat in zip(categories, total_seller_per_category):
    data.append({'Category': category, 'Total seller': sellercat})
